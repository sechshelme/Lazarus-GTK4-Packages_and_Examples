...
function g_spawn_error_quark: TGQuark; cdecl; external libgobject2_0;
function g_spawn_exit_error_quark: TGQuark; cdecl; external libgobject2_0;
function g_spawn_async(working_directory: Pgchar; argv: PPgchar; envp: PPgchar; flags: TGSpawnFlags; child_setup: TGSpawnChildSetupFunc;
  user_data: Tgpointer; child_pid: PGPid; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
...
function g_spawn_async_with_pipes_and_fds(working_directory: Pgchar; argv: PPgchar; envp: PPgchar; flags: TGSpawnFlags; child_setup: TGSpawnChildSetupFunc;
  ...
  stderr_pipe_out: Pgint; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
...
function g_spawn_sync(working_directory: Pgchar; argv: PPgchar; envp: PPgchar; flags: TGSpawnFlags; child_setup: TGSpawnChildSetupFunc;
  user_data: Tgpointer; standard_output: PPgchar; standard_error: PPgchar; wait_status: Pgint; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
function g_spawn_command_line_sync(command_line: Pgchar; standard_output: PPgchar; standard_error: PPgchar; wait_status: Pgint; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
function g_spawn_command_line_async(command_line: Pgchar; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
function g_spawn_check_wait_status(wait_status: Tgint; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
function g_spawn_check_exit_status(wait_status: Tgint; error: PPGError): Tgboolean; cdecl; external libgobject2_0;
procedure g_spawn_close_pid(pid: TGPid); cdecl; external libgobject2_0;
