...
function g_utf8_validate(str:Pgchar; max_len:Tgssize; end:PPgchar):Tgboolean;cdecl;external libgio2;
function g_utf8_validate_len(str:Pgchar; max_len:Tgsize; end:PPgchar):Tgboolean;cdecl;external libgio2;
