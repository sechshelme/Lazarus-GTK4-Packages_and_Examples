...
function g_date_get_type: TGType; cdecl; external libglib2;
function g_strv_get_type: TGType; cdecl; external libglib2;
function g_gstring_get_type: TGType; cdecl; external libglib2;
function g_hash_table_get_type: TGType; cdecl; external libglib2;
function g_array_get_type: TGType; cdecl; external libglib2;
function g_byte_array_get_type: TGType; cdecl; external libglib2;
function g_ptr_array_get_type: TGType; cdecl; external libglib2;
function g_bytes_get_type: TGType; cdecl; external libglib2;
function g_variant_type_get_gtype: TGType; cdecl; external libglib2;
function g_regex_get_type: TGType; cdecl; external libglib2;
function g_match_info_get_type: TGType; cdecl; external libglib2;
function g_error_get_type: TGType; cdecl; external libglib2;
function g_date_time_get_type: TGType; cdecl; external libglib2;
function g_time_zone_get_type: TGType; cdecl; external libglib2;
function g_io_channel_get_type: TGType; cdecl; external libglib2;
function g_io_condition_get_type: TGType; cdecl; external libglib2;
function g_variant_builder_get_type: TGType; cdecl; external libglib2;
function g_variant_dict_get_type: TGType; cdecl; external libglib2;
function g_key_file_get_type: TGType; cdecl; external libglib2;
function g_main_loop_get_type: TGType; cdecl; external libglib2;
function g_main_context_get_type: TGType; cdecl; external libglib2;
function g_source_get_type: TGType; cdecl; external libglib2;
function g_pollfd_get_type: TGType; cdecl; external libglib2;
function g_thread_get_type: TGType; cdecl; external libglib2;
function g_checksum_get_type: TGType; cdecl; external libglib2;
function g_markup_parse_context_get_type: TGType; cdecl; external libglib2;
function g_mapped_file_get_type: TGType; cdecl; external libglib2;
function g_option_group_get_type: TGType; cdecl; external libglib2;
function g_uri_get_type: TGType; cdecl; external libglib2;
function g_tree_get_type: TGType; cdecl; external libglib2;
function g_pattern_spec_get_type: TGType; cdecl; external libglib2;
function g_bookmark_file_get_type: TGType; cdecl; external libglib2;
function g_hmac_get_type: TGType; cdecl; external libglib2;
function g_dir_get_type: TGType; cdecl; external libglib2;
function g_rand_get_type: TGType; cdecl; external libglib2;
function g_strv_builder_get_type: TGType; cdecl; external libglib2;
function g_variant_get_gtype: TGType; cdecl; external libglib2;
