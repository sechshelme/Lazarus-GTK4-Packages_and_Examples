...
gpointer g_malloc0        (gsize	 n_bytes)  G_GNUC_ALLOC_SIZE(1);

gpointer g_realloc        (gpointer	 mem,
			   gsize	 n_bytes) ;

gpointer g_try_malloc     (gsize	 n_bytes)  G_GNUC_ALLOC_SIZE(1);

gpointer g_try_malloc0    (gsize	 n_bytes)  G_GNUC_ALLOC_SIZE(1);
