...
#  define G_INLINE_FUNC extern _MACRO_IN_2_48_FOR(static inline)
#  undef  G_CAN_INLINE
#else
#  define G_INLINE_FUNC static inline _MACRO_IN_2_48_FOR(static inline)
 ...
 *
 * In practice, this means that `` can be used with any function
 ...
 *
 * |[<!-- language="C" -->
 * gpointer g_malloc (gsize n_bytes)  G_GNUC_ALLOC_SIZE(1);
 * ]|
 *
 * See the
...
#define  __attribute__((__pure__))
#else
#define 
#endif

#if g_macro__has_attribute(__malloc__)
#define  __attribute__ ((__malloc__))
#else
#define 
#endif
 ...
 *                      gsize n_block_bytes)  G_GNUC_ALLOC_SIZE2(1, 2);
 * ]|
 *
 * See the [GNU C documentation](https://gcc.gnu.org/onlinedocs/gcc/Common-Function-Attributes.html#index-alloc_005fsize-function-attribute) for more details.
 *
...
#define G_GNUC_FUNCTION         __FUNCTION__ _MACRO_IN_2_26_FOR(G_STRFUNC)
#define G_GNUC_PRETTY_FUNCTION  __PRETTY_FUNCTION__ _MACRO_IN_2_26_FOR(G_STRFUNC)
#else   /* !__GNUC__ */
#define G_GNUC_FUNCTION         "" _MACRO_IN_2_26_FOR(G_STRFUNC)
#define G_GNUC_PRETTY_FUNCTION  "" _MACRO_IN_2_26_FOR(G_STRFUNC)
#endif  /* !__GNUC__ */
...
#define G_CONST_RETURN _MACRO_IN_2_30_FOR(const)
#else
#define G_CONST_RETURN const _MACRO_IN_2_30_FOR(const)
#endif
...
#define _MACRO _GLIB_GNUC_DO_PRAGMA(GCC warning "Deprecated pre-processor symbol")
#define _MACRO_FOR(f) \
...
#define _ENUMERATOR G_DEPRECATED
#define _ENUMERATOR_FOR(f) G_DEPRECATED_FOR(f)
#define GLIB_UNAVAILABLE_ENUMERATOR(maj,min) G_UNAVAILABLE(maj,min)
#else
#define _ENUMERATOR
#define _ENUMERATOR_FOR(f)
#define GLIB_UNAVAILABLE_ENUMERATOR(maj,min)
    ...
    (G_GNUC_CHECK_VERSION(3, 1) ||                 \
     (defined (__clang_major__) && (__clang_major__ > 3 || (__clang_major__ == 3 && __clang_minor__ >= 0))))
#define _TYPE G_DEPRECATED
#define _TYPE_FOR(f) G_DEPRECATED_FOR(f)
