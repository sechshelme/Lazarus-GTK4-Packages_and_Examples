...
{
  Automatically converted by H2Pas 1.0.0 from gparam.h
...
PGParamSpecPool  = ^GParamSpecPool;
PGParamSpecTypeInfo  = ^GParamSpecTypeInfo;
Pguint  = ^guint;
PGValue  = ^GValue;
{$IFDEF FPC}
{$PACKRECORDS C}
...
function G_PARAM_SPEC_CLASS(pclass : longint) : longint;
...
{ argument types are unknown }
{ return type might be wrong }   
function G_IS_PARAM_SPEC_CLASS(pclass : longint) : longint;
...
function g_param_spec_get_qdata(pspec:PGParamSpec; quark:TGQuark):Tgpointer;cdecl;external;
procedure g_param_spec_set_qdata(pspec:PGParamSpec; quark:TGQuark; data:Tgpointer);cdecl;external;
procedure g_param_spec_set_qdata_full(pspec:PGParamSpec; quark:TGQuark; data:Tgpointer; destroy:TGDestroyNotify);cdecl;external;
function g_param_spec_steal_qdata(pspec:PGParamSpec; quark:TGQuark):Tgpointer;cdecl;external;
...
(* Const before type ignored *)
function g_param_value_defaults(pspec:PGParamSpec; value:PGValue):Tgboolean;cdecl;external;
function g_param_value_validate(pspec:PGParamSpec; value:PGValue):Tgboolean;cdecl;external;
(* Const before type ignored *)
function g_param_value_is_valid(pspec:PGParamSpec; value:PGValue):Tgboolean;cdecl;external;
(* Const before type ignored *)
function g_param_value_convert(pspec:PGParamSpec; src_value:PGValue; dest_value:PGValue; strict_validation:Tgboolean):Tgboolean;cdecl;external;
(* Const before type ignored *)
(* Const before type ignored *)
function g_param_values_cmp(pspec:PGParamSpec; value1:PGValue; value2:PGValue):Tgint;cdecl;external;
(* Const before type ignored *)
...
procedure g_value_set_param_take_ownership(value:PGValue; param:PGParamSpec);cdecl;external;
(* Const before type ignored *)
...
(* Const before type ignored *)
function g_param_spec_is_valid_name(name:Pgchar):Tgboolean;cdecl;external;
{ For registering builting types  }
(* Const before type ignored *)
(* Const before type ignored *)
function _g_param_type_register_static_constant(name:Pgchar; pspec_info:PGParamSpecTypeInfo; opt_type:TGType):TGType;cdecl;external;
{ --- protected ---  }
(* Const before type ignored *)
(* Const before type ignored *)
(* Const before type ignored *)
function g_param_spec_internal(param_type:TGType; name:Pgchar; nick:Pgchar; blurb:Pgchar; flags:TGParamFlags):Tgpointer;cdecl;external;
function g_param_spec_pool_new(type_prefixing:Tgboolean):PGParamSpecPool;cdecl;external;
...
(* Const before type ignored *)
function g_param_spec_pool_lookup(pool:PGParamSpecPool; param_name:Pgchar; owner_type:TGType; walk_ancestors:Tgboolean):PGParamSpec;cdecl;external;
function g_param_spec_pool_list_owned(pool:PGParamSpecPool; owner_type:TGType):PGList;cdecl;external;
function g_param_spec_pool_list(pool:PGParamSpecPool; owner_type:TGType; n_pspecs_p:Pguint):^PGParamSpec;cdecl;external;
procedure g_param_spec_pool_free(pool:PGParamSpecPool);cdecl;external;
{ contracts:
 *
