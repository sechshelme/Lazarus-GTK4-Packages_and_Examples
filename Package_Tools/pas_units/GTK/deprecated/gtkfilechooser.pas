...
function gtk_file_chooser_set_file(chooser: PGtkFileChooser; file_: PGFile; error: PPGError): Tgboolean; cdecl; external libgtk4;
function gtk_file_chooser_get_files(chooser: PGtkFileChooser): PGListModel; cdecl; external libgtk4;
function gtk_file_chooser_set_current_folder(chooser: PGtkFileChooser; file_: PGFile; error: PPGError): Tgboolean; cdecl; external libgtk4;
