...
function gtk_paper_size_new_custom(Name: PChar; display_name: PChar; Width: Tdouble; Height: Tdouble; unit_: TGtkUnit): PGtkPaperSize; cdecl; external libgtk4;
...
function gtk_paper_size_get_width(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
function gtk_paper_size_get_height(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
...
procedure gtk_paper_size_set_size(size: PGtkPaperSize; Width: Tdouble; Height: Tdouble; unit_: TGtkUnit); cdecl; external libgtk4;
function gtk_paper_size_get_default_top_margin(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
function gtk_paper_size_get_default_bottom_margin(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
function gtk_paper_size_get_default_left_margin(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
function gtk_paper_size_get_default_right_margin(size: PGtkPaperSize; unit_: TGtkUnit): Tdouble; cdecl; external libgtk4;
