...
procedure gdk_cairo_draw_from_gl(cr: Pcairo_t; surface: PGdkSurface; Source: longint; source_type: longint; buffer_scale: longint;  x: longint; y: longint; Width: longint; Height: longint); cdecl; external libgtk4;
